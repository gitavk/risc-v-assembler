...
# Step 2: compute (a + (c ^ b)), return result in a0
# ----------------------------------------------------------
on_event:
    ...
    xor a1, a2, a1          # a1 <- c ^ b       (bitwise XOR)
    add a0, a0, a1          # a0 <- a + (c ^ b)  — final result
